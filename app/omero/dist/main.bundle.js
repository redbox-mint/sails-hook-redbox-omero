...
var CreateWorkspaceField = /** @class */ (function (_super) {
    ...
    CreateWorkspaceField.prototype.createWorkspace = function () {
        ...
        this.omeroService.info().then(function (res) {
            _this.host = res.host;
            return _this.omeroService.createWorkspace(_this.creation);
        }).then(function (response) {
            if (!response.status) {
                ...
                _this.creation.location = _this.host + _this.workspaceLink + _this.creation.id;
...
var LinkModalWorkspaceField = /** @class */ (function (_super) {
    ...
    LinkModalWorkspaceField.prototype.linkModal = function (_a) {
        ...
        return this.omeroService.info()
            .then(function (res) {
            _this.host = res.host;
            _this.currentWorkspace.location = _this.host + _this.workspaceLink + workspace['@id'];
            return _this.omeroService.link({
                rdmp: rdmp,
                project: _this.currentWorkspace,
                recordMap: _this.recordMap
            });
        }).then(function (response) {
            if (!response.status) {
...
var OMEROService = /** @class */ (function (_super) {
    ...
    OMEROService.prototype.info = function () {
        var _this = this;
        var wsUrl = this.brandingAndPortalUrl + "/ws/omero/info";
    ...
    OMEROService.prototype.projects = function (limit, offset) {
        var _this = this;
        var wsUrl = this.brandingAndPortalUrl + "/ws/omero/projects/" + limit + "/" + offset + "?ts=" + new Date().getTime();
        return this.http.get(wsUrl, this.options)
            .toPromise()
            .then(function (res) {
            return _this.extractData(res);
